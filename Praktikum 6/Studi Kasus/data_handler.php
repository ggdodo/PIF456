	...
	if($res) {
		...
		if ($num) {
			?>
					...
					<a href="<?php echo $root; ?>&amp;act=add"><i class="icon-pencil"></i> Tambah Data</a>
			...
			while($row = mysql_fetch_row($res)) {
				...
				<tr class="<?php echo $bg; ?>">
					...
					<td align="center">
					|<a href ="<?php echo $root;?>&amp;act=edit&amp;id=<?php echo $id;?>"><i class="icon-edit"></i> Edit</a> | <a href ="xx.php"><i class="icon-remove"></i> Hapus </a>
					</td>
				</tr>
				<?php
				$i++;

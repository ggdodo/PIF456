...
$query = mysql_query('select nim, nama, alamat from maha');
...
$objPHPExcel->getActiveSheet()->setCellValue('E2', "PEMERINTAH KOTA KEDIRI");
...
$objPHPExcel->getActiveSheet()->setCellValue('E4', "SMPN 1 GURAH");
$objPHPExcel->getActiveSheet()->mergeCells('E5:M5');
$objPHPExcel->getActiveSheet()->setCellValue('E5', "Jl. Dr.Sutomo 2, Telp. 482713");
$objPHPExcel->getActiveSheet()->mergeCells('E6:M6');
$objPHPExcel->getActiveSheet()->setCellValue('E6', "REKAPITULASI DATA SISWA TAHUN 2011");
